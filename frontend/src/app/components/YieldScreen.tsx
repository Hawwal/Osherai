    ...
    <div className="flex flex-col h-full overflow-y-auto pb-28" style={{ background: "#f5f5fb", scrollbarWidth: "none" }}>
      ...
      <div className="px-5 pt-12 pb-5">
        <h1 className="font-display" style={{ fontSize: "1.6rem", fontWeight: 800, color: "#0d0d14", letterSpacing: "-0.02em", lineHeight: 1.15 }}>
          Let Your Savings<br />Work For You
        </h1>
        <p style={{ fontSize: "0.85rem", color: "#9a9ab8", marginTop: 6 }}>Earn yield on your stablecoin savings automatically.</p>
      </div>
      ...
      <div className="mx-4 mb-5 rounded-3xl overflow-hidden" style={{ background: "#171717", boxShadow: "0 8px 28px rgba(23,23,23,0.25)" }}>
        <div style={{ padding: "22px 22px 18px", position: "relative" }}>
          ...
          <p style={{ fontSize: "0.68rem", color: "rgba(204,204,247,0.5)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 4, position: "relative", zIndex: 1 }}>Current APY</p>
          <div className="flex items-end gap-2 mb-5 relative z-10">
            <p className="font-display" style={{ fontSize: "3rem", fontWeight: 800, color: "#fff", lineHeight: 1, letterSpacing: "-0.03em" }}>6.2</p>
            <p className="font-display" style={{ fontSize: "1.5rem", fontWeight: 700, color: "#CCCCF7", marginBottom: 8 }}>%</p>
            <div className="flex items-center gap-1 ml-1 mb-3" style={{ background: "rgba(76,175,117,0.2)", padding: "3px 8px", borderRadius: 6 }}>
              ...
              <span style={{ fontSize: "0.7rem", color: "#4caf75", fontWeight: 700 }}>Live rate</span>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-2.5 relative z-10">
            {[
              { l: "Idle Balance", v: "$420.40" },
              { l: "Est. Annual Earn", v: "$26.04" },
            ].map(({ l, v }) => (
        ...
        <div className="px-5 py-4" style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
          <button className="w-full py-3.5 rounded-2xl flex items-center justify-center gap-2" style={{ background: "#CCCCF7", color: "#171717", fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, fontSize: "0.95rem" }}>
            <Zap size={16} fill="#171717" /> Enable Yield
          </button>
        </div>
      </div>
      ...
      <div className="px-5 mb-4">
        ...
        <div className="flex flex-col gap-3">
          {[
            { title: "Stable Savings Yield", apy: "6.2%", risk: "Low Risk", desc: "Auto-compounding on your idle USDC. Principal fully protected.", tag: "Active", tagC: "#2d7a47", tagBg: "#e8f5ec" },
            { title: "cUSD Liquidity Pool", apy: "9.4%", risk: "Medium Risk", desc: "Provide liquidity for higher returns. Some price exposure.", tag: "New", tagC: "#4040b0", tagBg: "#e8e8ff" },
          ].map((op) => (
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div style={{ textAlign: "right" }}>
                    <p style={{ fontSize: "0.62rem", color: "#b0b0c8", textTransform: "uppercase" }}>APY</p>
      ...
      <div className="mx-5 rounded-2xl p-4 flex gap-3" style={{ background: "#fff", border: "1px solid rgba(204,204,247,0.5)" }}>
        ...
        <p style={{ fontSize: "0.8rem", color: "#5a5a8a", lineHeight: 1.6 }}>
          Yield is generated through audited DeFi protocols on the Celo blockchain. Your principal is always protected in stable savings products.
        </p>
      </div>

      <div className="flex items-center justify-center gap-1.5 mt-4 mx-5">
        <Lock size={12} color="#b0b0c8" />
        <p style={{ fontSize: "0.72rem", color: "#b0b0c8" }}>Non-custodial · Audited · Your keys, your funds</p>
      </div>
    </div>
  );
}
